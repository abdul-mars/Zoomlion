...
<html lang="en">
    ...
    <body class="bg-light">
        <div class="container">
            <div class="row align-items-center mt-5">
                <div class="col-md-6 col-lg-7">
                    <img src="img/zoomlion.jpg" class="box-shadow" alt="zoomlion" width="700" heigth="1000">
                </div>
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="alert alert-danger text-center" role="alert" id="loginAlert"></div>
                        <div>
                            <hr>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div class="row">
                                ...
                                <button class="btn btn-zoom btn-lg btn-block" id="loginSubmit" name="submit" type="submit">Login</button>
                                <!-- </div> -->
                                <!-- </div> -->
                            </div>
                            <div class="row mt-2">
        ...
        <script src="styles/bootstrap@5.2.0-beta1.min.js?style=<?= time(); ?>"></script>
